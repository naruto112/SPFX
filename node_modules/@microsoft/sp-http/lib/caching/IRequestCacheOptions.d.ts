 ...
 * @internal
 */
export declare const enum CacheStrategy {
    /**
     ...
     * network request to update the cache right away with fresh data
     */
    CacheAndNetwork = 2
}
/**
 * Represents the configurable options for cached requests
 *
 * @internal
 */
export interface IRequestCacheOptions {
     ...
     * If undefined, stale cached data will be returned if available.
     */

 ...
 * @internal
 */
export declare class CacheDataProviderService<TKey> {
    ...
    * @internal
    */
    _provider: ICacheDataProvider<TKey>;
}
/**
 ...
 * @internal
 */
export declare const cacheDataProviderServiceKey: ServiceKey<CacheDataProviderService<{}>>;

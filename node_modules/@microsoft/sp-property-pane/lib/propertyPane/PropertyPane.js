...
var PropertyPane = /** @class */ (function (_super) {
        ...
        return (React.createElement(Fabric, { "data-sp-feature-tag": 'Property Pane', "data-sp-feature-instance-id": '_Property Pane' },
            ...
            React.createElement(FocusTrapZone, { isClickableOutsideFocusTrap: true, firstFocusableSelector: this._cssClassForActionableElement, forceFocusInsideTrap: false },
                React.createElement("div", { className: this.props.renderNarrow ?
                        ...
                        propertyPaneStyles.propertyPane, role: 'dialog', "aria-label": Text.format(Strings.PropertyPaneTitle, this.props.data.title), "aria-describedby": this._descriptionId, ref: function (c) { return _this._propertyPane = c; }, onKeyDown: this._onPropertyPaneKeyDown, key: this.props.data.webPartId },
    ...
    var PropertyPane_1;
    PropertyPane = PropertyPane_1 = tslib_1.__decorate([
        sealed
    ], PropertyPane);
    return PropertyPane;
}(React.Component));

...
class CommandLineMigrationAdvisor {
    ...
    static _reportDeprecated(message) {
        console.error(colors.red(Utilities_1.Utilities.wrapWords('ERROR: You specified an outdated command-line that is no longer supported by this version of Rush:')));
        console.error(colors.yellow(Utilities_1.Utilities.wrapWords(message)));
        console.error();

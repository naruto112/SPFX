...
import { SPEvent, ServiceKey, ServiceScope } from '@microsoft/sp-core-library';
/**
 ...
 * @internal
 */
export declare class IsolatedDynamicDataTransceiver {
    /**
     * The service key for IsolatedDynamicDataTransceiver service.
     */
    static readonly serviceKey: ServiceKey<IsolatedDynamicDataTransceiver>;
    private _onMessageReceivedEvent;
    /**
     ...
     */
    static sendMessage(eventType: IsolatedDynamicDataMessageType, data?: Object): void;
    constructor(serviceScope: ServiceScope);
    /**
     * Event that gets raised when the list of Dynamic Data Sources gets updated.
     * @eventproperty
     */
    readonly messageReceivedEvent: SPEvent<IIsolatedDynamicDataMessage>;
    ...
    private _notifyPropertyDefinitionsReceived;
    private _notifyPropertyValueReceived;
    private _notifyAnnotatedPropertyValueReceived;
}
//# sourceMappingURL=IsolatedDynamicDataTransceiver.d.ts.map
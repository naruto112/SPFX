...
var ClientManifestData = /** @class */ (function () {
    ...
    ClientManifestData.serviceKey = ServiceKey.create('sp-core-library:ClientManifestData', ClientManifestData);
    return ClientManifestData;
}());
export default ClientManifestData;
//# sourceMappingURL=ClientManifestData.js.map
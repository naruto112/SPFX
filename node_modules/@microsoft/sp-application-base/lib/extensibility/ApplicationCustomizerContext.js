    ...
    function ApplicationCustomizerContext(extensionContextParameters, applicationCustomizerContextParameters) {
        ...
        if (!Killswitches.isPreallocatedPlaceholdersforApplicationCustomizersKSActive()) {
            ...
            _this._placeholderProvider =
                new PlaceholderProvider(_this.serviceScope, applicationCustomizerContextParameters, _this._componentTag);
        }
        else {
            _this._placeholderProvider =
                new PlaceholderProvider(_this.serviceScope, { sequence: applicationCustomizerContextParameters.sequence });
        }

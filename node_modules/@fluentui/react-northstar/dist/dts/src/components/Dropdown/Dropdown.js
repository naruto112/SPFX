...
exports.Dropdown = function (props) {
    ...
    var renderItemsList = function (highlightedIndex, toggleMenu, selectItemAtIndex, getMenuProps, getItemProps, getInputProps) {
        ...
        return (React.createElement(react_component_ref_1.Ref, { innerRef: function (listElement) {
            ...
            React.createElement(positioner_1.Popper, tslib_1.__assign({ align: align, position: position, offset: offset, rtl: context.rtl, enabled: open, targetRef: containerRef, unstable_pinned: unstable_pinned, positioningDependencies: [items.length] }, positioningProps), List_1.List.create(list, {

...
exports.SplitButton = function (props) {
    ...
    setStart();
    var button = props.button, disabled = props.disabled, menu = props.menu, primary = props.primary, secondary = props.secondary, toggleButton = props.toggleButton, size = props.size, position = props.position, align = props.align, flipBoundary = props.flipBoundary, overflowBoundary = props.overflowBoundary, popperRef = props.popperRef, positionFixed = props.positionFixed, offset = props.offset, unstable_pinned = props.unstable_pinned, className = props.className, design = props.design, styles = props.styles, accessibility = props.accessibility, variables = props.variables;

...
exports.checkboxStyles = {
    root: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ position: 'relative', display: ['inline-grid', '-ms-inline-grid'], gridTemplateColumns: "1fr " + v.gap + " auto", 

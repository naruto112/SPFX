                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.state.itemId) {
                            ...
                            files.push(file);
                            this.setState({
                                filesToUpload: __spreadArrays(files)
                            });
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.setState({
                            filesToUpload: __spreadArrays(filesToUpload),
                            attachments: __spreadArrays(attachments)
                        });
                        _a.label = 4;
                    case 4:
                        this.setState({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, new Promise(function (resolve, error) {
                            _this.setState({
                                filesToUpload: [],
                                itemId: itemId

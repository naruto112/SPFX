...
export var CommentItem = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Stack, null,
            React.createElement(ActivityItem, { activityPersonas: [{ imageUrl: "" + PHOTO_URL + author.email }], activityDescription: activityDescription, timeStamp: format(parseISO(createdDate), "PPpp") }))));
};

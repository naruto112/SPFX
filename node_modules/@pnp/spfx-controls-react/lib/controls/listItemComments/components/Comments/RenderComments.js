...
export var RenderComments = function () {
    ...
    var _b = useListItemCommentsStyles(), documentCardStyles = _b.documentCardStyles, itemContainerStyles = _b.itemContainerStyles, deleteButtonContainerStyles = _b.deleteButtonContainerStyles;
    var comments = listItemCommentsState.comments, isLoading = listItemCommentsState.isLoading, selectedComment = listItemCommentsState.selectedComment;
    var _c = useBoolean(true), hideDialog = _c[0], setHideDialog = _c[1].toggle;
    var onRenderCell = useCallback(function (comment, index) {
        return (React.createElement(DocumentCard, { styles: documentCardStyles, key: index },

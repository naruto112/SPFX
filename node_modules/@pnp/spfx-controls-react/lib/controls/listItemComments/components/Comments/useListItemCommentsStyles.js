...
export var useListItemCommentsStyles = function () {
    var _a;
    var _b = React.useContext(AppContext), theme = _b.theme, numberCommentsPerPage = _b.numberCommentsPerPage;
    ...
    var documentCardUserStyles = {
        root: {
            marginTop: 2,
            backgroundColor: (_a = theme) === null || _a === void 0 ? void 0 : _a.white,

...
export declare const b64toBlob: (b64Data: any, contentType: string, sliceSize?: number) => Promise<Blob>;
 ...
 * @param url
 */
export declare const getMd5HashForUrl: (url: string) => Promise<unknown>;
/**

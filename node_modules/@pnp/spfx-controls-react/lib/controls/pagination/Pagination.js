...
var Pagination = /** @class */ (function (_super) {
    ...
    Pagination.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: styles.pagination + " pagination-container" },
            React.createElement(Stack, { horizontal: true, horizontalAlign: "center", verticalAlign: "center", tokens: { childrenGap: 1 }, wrap: true },
                !this.props.hideFirstPageJump &&
                    React.createElement(DefaultButton, { className: styles.buttonStyle + " pagination-button pagination-button_first", onClick: function () { return _this.onClick(1); }, iconProps: { iconName: "DoubleChevronLeft" } }),
                ...
                !this.props.hideLastPageJump &&
                    React.createElement(DefaultButton, { className: styles.buttonStyle + " pagination-button pagination-button_last", onClick: function () { return _this.onClick(_this.props.totalPages); }, iconProps: { iconName: "DoubleChevronRight" } }))));
    };
        ...
        if (pageNumber === this.state.currentPage) {
            ...
            if (!(pageNumber < this.state.currentPage - this.state.limiter || pageNumber > this.state.currentPage + this.state.limiter)) {
                ...
                if (this.props.limiterIcon) {
                    return (React.createElement(DefaultButton, { className: styles.buttonStyle, onClick: function () { return _this.onClick(pageNumber); }, iconProps: { iconName: this.props.limiterIcon ? this.props.limiterIcon : "More" } }));
                }
                else {
                    return (React.createElement(DefaultButton, { className: styles.buttonStyle, onClick: function () { return _this.onClick(pageNumber); }, iconProps: { iconName: this.props.limiterIcon ? this.props.limiterIcon : "More" } }));
                }

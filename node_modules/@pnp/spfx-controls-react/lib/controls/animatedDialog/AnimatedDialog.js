...
var mainAnimationClass = animationPrefix + "animated";
var defaultDialogAnimationClass = animationPrefix + "bounceIn";
var defaultIconAnimationClass = animationPrefix + "zoomIn";
export function AnimatedDialog(props) {
    ...
    var containerAnimationClass = currentContainerClass + " " + mainAnimationClass + " " + animationPrefix + "fast";
    ...
    useEffect(function () {
        var containerClassName = containerAnimationClass + " " + defaultDialogAnimationClass;

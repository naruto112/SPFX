...
var ComboBoxListItemPicker = /** @class */ (function (_super) {
    ...
    ComboBoxListItemPicker.prototype.loadOptions = function (props, isInitialLoad) {
        return __awaiter(this, void 0, void 0, function () {
            var filter, keyColumnInternalName, listId, columnInternalName, webUrl, itemLimit, onInitialized, query, keyColumnName, listItems, selectedItems;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filter = props.filter, keyColumnInternalName = props.keyColumnInternalName, listId = props.listId, columnInternalName = props.columnInternalName, webUrl = props.webUrl, itemLimit = props.itemLimit, onInitialized = props.onInitialized;
                        query = filter || "";
                        keyColumnName = keyColumnInternalName || "Id";
                        if (!(!this._options || listId !== this.props.listId)) return [3 /*break*/, 2];
    ...
    ComboBoxListItemPicker.prototype._getSelectedItems = function (props) {
        ...
        if (((_a = selectedItems) === null || _a === void 0 ? void 0 : _a.length) > 0) {

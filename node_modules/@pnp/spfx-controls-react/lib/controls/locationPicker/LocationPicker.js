...
var LocationPicker = /** @class */ (function (_super) {
    ...
    */
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.props.context.spHttpClient.post(this.props.context.pageContext.web.serverRelativeUrl + "/_api/SP.OAuth.Token/Acquire", SPHttpClient.configurations.v1, spOpts)];
                    case 1:
                        response = _a.sent();
    ...
    LocationPicker.prototype.getLocatios = function (searchText) {
        return __awaiter(this, void 0, void 0, function () {
            var optionsForCustomRender_1, requestHeaders, spOpts, client1, response1, json, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, this.props.context.aadHttpClientFactory.getClient("https://outlook.office365.com")];
                    case 1:
                        client1 = _a.sent();
                        return [4 /*yield*/, client1.post("https://outlook.office365.com/SchedulingB2/api/v1.0/me/findmeetinglocations", AadHttpClient.configurations.v1, spOpts)];
                    case 2:
                        response1 = _a.sent();

...
var IFrameDialog = /** @class */ (function (_super) {
    ...
    IFrameDialog.prototype.render = function () {
        ...
        return (React.createElement(Dialog, __assign({ className: this.state.dialogId + " " + (className || ''), styles: dlgStyles, modalProps: dlgModalProps, dialogContentProps: dlgContentProps }, omit(this.props, 'className', 'modalProps', 'dialogContentProps')),

...
var DateTimePicker = /** @class */ (function (_super) {
    ...
    DateTimePicker.prototype.render = function () {
        ...
        timeDisplayControlType = _a.timeDisplayControlType, placeholder = _a.placeholder, showLabels = _a.showLabels, minDate = _a.minDate, maxDate = _a.maxDate, minutesIncrementStep = _a.minutesIncrementStep;
        ...
        return (React.createElement("div", { className: styles.dateTimePicker },
            ...
            React.createElement("div", { className: styles.container },
                React.createElement("div", { className: styles.row },
                    ...
                    React.createElement("div", { className: styles.picker },
                        React.createElement(DatePicker, { formatDate: formatDate, disabled: disabled, value: value, strings: dateStrings, isMonthPickerVisible: isMonthPickerVisible, onSelectDate: this.onSelectDate, allowTextInput: true, firstDayOfWeek: firstDayOfWeek, showGoToToday: showGoToToday, showMonthPickerAsOverlay: showMonthPickerAsOverlay, showWeekNumbers: showWeekNumbers, placeholder: placeholder, minDate: minDate, maxDate: maxDate, textField: {

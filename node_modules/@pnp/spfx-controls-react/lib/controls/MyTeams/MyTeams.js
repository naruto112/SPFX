...
export var MyTeams = function (props) {
    var _a;
    var _b = getMyTeamsStyles(props.themeVariant), stackStyles = _b.stackStyles, stackTokens = _b.stackTokens, styleClasses = _b.styleClasses, titleStyles = _b.titleStyles;
    ...
    var _c = React.useReducer(myTeamsReducer, initialState), state = _c[0], dispatch = _c[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Customizer, { settings: { theme: themeVariant } },
            React.createElement(Stack, { styles: stackStyles, tokens: stackTokens },
                ...
                hasError ? (React.createElement(ShowMessage, __assign({}, message))) : (React.createElement("div", { className: styleClasses.teamsContainer }, !((_a = myTeams) === null || _a === void 0 ? void 0 : _a.length) && !isLoading ? (React.createElement(Stack, { horizontal: true, horizontalAlign: "center", verticalAlign: "center", tokens: { childrenGap: 20 }, styles: { root: { margin: 20 } } },

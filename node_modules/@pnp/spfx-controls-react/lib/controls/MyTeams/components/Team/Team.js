...
export var Team = function (props) {
    ...
    React.useEffect(function () {
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            var _members, teamOwners, _renderOwners, _i, teamOwners_1, teamOwner, publicChannels, privateChannels, _renderMembers, allChannels, _a, _members_1, teamMember, channels, _b, channels_1, channel, error_1, messageError;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        allChannels = __spreadArrays(publicChannels, privateChannels);
                        dispatch({
    ...
    var teamMembers = state.teamMembers, teamsOwners = state.teamsOwners, hasError = state.hasError, isLoading = state.isLoading, channelsMenu = state.channelsMenu, message = state.message;
